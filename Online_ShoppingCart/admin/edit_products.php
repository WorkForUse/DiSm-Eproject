    ...
    <form action="" method="post" entype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image1 ?>" class="product_img" width="20%">
            </div>
        </div>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image2 ?>" class="product_img" width="20%">
            </div>
        </div>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                ...
                <img src="./product_images/<?php echo $product_image3 ?>" class="product_img" width="20%">
            </div>
        </div>
        ...
        <div class="w-50 m-auto">
            <input type="submit" name="edit_product" value="Update product" class="btn btn-success text-white border-0 rounded">
        </div>
    </form>
</div>
