...
<body>
    ...
    <form action="" method="post" entype="multipart/form-data" class="text-center">
        ...
        <div class="form-outline mb-4">
            ...
            <br>
            <input type="submit" value="Update" class="bg-dark bg-gradient text-white rounded py-2 px-3 border-0" name="user_update">
        </div>
    </form>
</body>
